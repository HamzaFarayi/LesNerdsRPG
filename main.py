...
def options():
    while True:
        ...
        OPTIONS_RECT = OPTIONS_TEXT.get_rect(center=(400, 104))
        SCREEN.blit(OPTIONS_TEXT, OPTIONS_RECT)

        OPTIONS_BACK = Button(image=None, pos=(400, 308), 
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(30).render("MENU PRINCIPAL", True, "#b68f40")
        MENU_RECT = MENU_TEXT.get_rect(center=(425, 100))

        PLAY_BUTTON = Button(image=pygame.image.load("images/Play Rect.png"), pos=(400, 240), 
                            text_input="JOUER", font=get_font(35), base_color="#d7fcd4", hovering_color="White")
        ...
        QUIT_BUTTON = Button(image=pygame.image.load("images/Quit Rect.png"), pos=(400, 420), 
                            text_input="QUITTER", font=get_font(35), base_color="#d7fcd4", hovering_color="White")
